    ...
    return [
      {
        ...
        headers: [
          ...
          // CSP básico para producción
          {
            ...
            value: [
              "default-src 'self';",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' blob: https://www.gstatic.com https://firebasestorage.googleapis.com https://apis.google.com;",
              ...
              "frame-src 'self' blob: https://red-agricola-e06cc.firebaseapp.com/ https://red-agricola-e06cc.web.app;",
              "object-src 'none';",
              "base-uri 'self';",
              "form-action 'self';",
            ].join(" "),
