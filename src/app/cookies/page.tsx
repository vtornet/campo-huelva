...
export const metadata: Metadata = {
  ...
  description: "Política de Cookies de Red Agro. Información sobre las cookies que utilizamos.",
};
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 space-y-8 text-slate-700 leading-relaxed">
          ...
          <section>
            ...
            <h3 className="font-semibold text-slate-800 mb-2">4.1. Ajustes en tu navegador</h3>
            <p className="mb-3">
              Puedes configurar tu navegador para rechazar cookies o eliminar las ya instaladas:
            </p>
            <ul className="list-disc ml-6 mb-4 space-y-1">
            ...
            <h3 className="font-semibold text-slate-800 mb-2">4.2. Aviso importante</h3>
          ...
          {/* Banner de cookies simulado */}
          <div className="bg-slate-100 rounded-xl p-6 border border-slate-200">
            <h3 className="font-semibold text-slate-800 mb-3">Configuración de Cookies (Simulada)</h3>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-sm">Cookies Técnicas (Necesarias)</p>
                  <p className="text-xs text-slate-500">Esenciales para el funcionamiento de la plataforma</p>
                </div>
                <span className="text-xs bg-slate-300 text-slate-700 px-3 py-1 rounded-full">Siempre activas</span>
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-sm">Cookies de Preferencias</p>
                  <p className="text-xs text-slate-500">Recuerdan tu configuración (filtros, idioma)</p>
                </div>
                <span className="text-xs bg-green-100 text-green-700 px-3 py-1 rounded-full">Aceptadas</span>
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-sm">Cookies Analíticas</p>
                  <p className="text-xs text-slate-500">Nos ayudan a mejorar la plataforma</p>
                </div>
                <span className="text-xs bg-green-100 text-green-700 px-3 py-1 rounded-full">Aceptadas</span>
              </div>
            </div>
            <p className="text-xs text-slate-500 mt-4">
              * Esta plataforma utiliza cookies técnicas y de preferencias esenciales para su funcionamiento.
              En este momento no utilizamos cookies de terceros para publicidad ni tracking externo.
            </p>
          </div>
