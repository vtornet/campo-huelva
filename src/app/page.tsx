                  ...
                  >
                    ...
                    {post.type !== 'DEMAND' && (
                      <div className="mt-4 flex flex-wrap gap-2">
                        ...
                        {/* Salario */}
                        {post.salaryPeriod === "NO_ESPECIFICADO" ? (
                          <span className="inline-flex items-center gap-1 text-xs bg-slate-100 text-slate-600 px-2 py-1 rounded-full font-medium border border-slate-200">
                            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
