      ...
      <div className="max-w-5xl mx-auto p-4 md:p-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 mb-6 shadow-black/5">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <button
              onClick={() => {
                if (role === 'COMPANY') router.push(`/${locale}/profile/company`);
                ...
                else router.push(`/${locale}/profile/worker`);
              }}
          ...
          <div className="p-6">
                      ...
                      <div key={post.id} className={`bg-white p-4 rounded-xl border transition-all duration-200 hover:shadow-md ${
                        ...
                        <div className="flex justify-between items-start gap-4">
                          ...
                          <div className="flex gap-2">
                            <button
                              onClick={() => router.push(`/${locale}/publish?edit=${post.id}`)}
            ...
            {activeTab === "search" && role === 'COMPANY' && (
              <div className="text-center py-12">
                ...
                <button
                  onClick={() => router.push(`/${locale}/profile/company/search`)}
