...
export default function ApplicationsPage() {
  ...
  // Verificar email antes de permitir ver candidatos
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 max-w-md text-center">
          ...
          <h2 className="text-xl font-bold text-yellow-800 mb-2">Verifica tu email</h2>
          <p className="text-yellow-700 mb-4">Debes verificar tu email para ver los candidatos inscritos en tus ofertas.</p>
          <button
