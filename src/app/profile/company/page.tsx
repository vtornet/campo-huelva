      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-indigo-50/80 border border-indigo-100 rounded-2xl p-4 mb-6 flex items-start gap-3">
          ...
          <span className="text-sm text-indigo-800">
            <strong>Política de privacidad:</strong> Los datos de contacto que proporcionas no serán públicos y solo serán utilizados por el equipo de <strong>Red Agro</strong> para contactarte en caso de necesidad. El nombre de tu empresa será público únicamente en las ofertas que publiques.
          </span>
        </div>
